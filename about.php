...
<html lang="de">
  ...
  <body class="page-body">
    ...
    <header id="header" class="header h-fullscreen__page text-light">
      <div class="media-container parallax-window" data-parallax="scroll" data-image-src="http://localhost/assets/img/bg/bg-2.jpg"></div>
    ...
    <main class="main-content">
      ...
      <!-- content area -->
      <section class="content-section text-center text-light parallax-window position-relative" data-parallax="scroll" data-image-src="http://localhost/assets/img/bg/bg-4.jpg">
        ...
        <div class="container">
          <div class="row gutters-y align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0 ml-auto">
              <div class="ar-4_3 bs-c bp-c br-n rounded" style="background-image: url(http://localhost/assets/img/bg/bg-3.jpg)"></div>
            </div>
      ...
      <!-- content area -->
      <div class="about-features content-section bp-c br-n bs-c" style="background-image: url(http://localhost/assets/img/bg/bg_a.jpg)" data-overlay="8">
        ...
        <div class="container-fluid">
          <div class="row py-2 py-lg-1">
            <div class="col-md-6 col-lg d-flex pl-lg-0 pr-lg-1 mb-4 mb-lg-0">
              <div class="tile d-flex px-0">
                <div class="tile">
                  <figure class="h-100 ar-8_5 bs-c br-n bp-c" style="background-image: url(http://localhost/assets/img/thumb/3.jpg);"></figure>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg d-flex px-lg-1 mb-4 mb-lg-0">
              <div class="tile d-flex px-0">
                <div class="tile">
                  <figure class="h-100 ar-8_5 bs-c br-n bp-c" style="background-image: url(http://localhost/assets/img/thumb/11.jpg);"></figure>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg d-flex px-lg-1 mb-4 mb-md-0">
              <div class="tile d-flex px-0">
                <div class="tile">
                  <figure class="h-100 ar-8_5 bs-c br-n bp-c" style="background-image: url(http://localhost/assets/img/thumb/6.jpg);"></figure>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg d-flex pr-lg-0 pl-lg-1">
              <div class="tile d-flex px-0">
                <div class="tile">
                  <figure class="h-100 ar-8_5 bs-c br-n bp-c" style="background-image: url(http://localhost/assets/img/thumb/5.jpg);"></figure>
                </div>
              </div>
            </div>
          </div>
          <div class="row py-2 py-lg-1">
            <div class="col-md mb-4 mb-md-0 d-flex pr-lg-1 pl-lg-0">
              <div class="tile d-flex px-0">
                <div class="tile">
                  <figure class="h-100 ar-8_5 bs-c br-n bp-c" style="background-image: url(http://localhost/assets/img/thumb/4.jpg);"></figure>
                </div>
              </div>
            </div>
            <div class="col-md mb-4 mb-md-0 d-flex px-lg-1">
              <div class="tile d-flex px-0">
                <div class="tile">
                  <figure class="h-100 ar-8_5 bs-c br-n bp-c" style="background-image: url(http://localhost/assets/img/thumb/7.jpg);"></figure>
                </div>
              </div>
            </div>
            <div class="col-md d-flex pl-lg-1 pr-lg-0">
              <div class="tile d-flex px-0">
                <div class="tile">
                  <figure class="h-100 ar-8_5 bs-c br-n bp-c" style="background-image: url(http://localhost/assets/img/thumb/12.jpg);"></figure>
                </div>
              </div>
            </div>
          </div>
      ...
      <!-- content area -->
      <section class="content-section latest-articles text-center text-light bs-c bp-c br-n position-relative" data-overlay="7" style="background-image: url(http://localhost/assets/img/bg/bg-3.jpg)">
    ...
    <!-- Main JS -->
    <script src="http://localhost/assets/js/main.js" id="_mainJS"></script>
  </body>
</html>