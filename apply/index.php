...
<html lang="de">
  <head>
    ...
    <title>Verany • Apply Center</title>
          ...
          <header class="header mb-8">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb-product breadcrumb breadcrumb-nowrap breadcrumb-angle bg-transparent pl-0 pr-0 mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Apply Center</li>
              </ol>
            </nav>
          </header>
            ...
            <div class="row mb-8 mb-lg-10">
              <div class="col-12">
                <header class="text-center mb-6 mb-md-8">
                  <h2 class="mb-0">Become part of our team!</h2>
                    ...
                    <a href="help-center-article.html">
                      <div class="card help_card">
                        <div class="card-body py-7">
                          ...
                          <h5 class="card-title mb-0">Builder</h5>
                        </div>
                      </div>
                    </a>
                  </div>
                    ...
                    <a href="help-center-article.html">
                      <div class="card help_card">
                        <div class="card-body py-7">
                          ...
                          <h5 class="card-title mb-0">Designer</h5>
                        </div>
                      </div>
                    </a>
                  </div>
                    ...
                    <a href="help-center-article.html">
                      <div class="card help_card">
                        <div class="card-body py-7">
                          ...
                          <h5 class="card-title mb-0">Helper</h5>
                        </div>
                      </div>
                    </a>
                  </div>
                    ...
                    <a href="help-center-article.html">
                      <div class="card help_card">
                        <div class="card-body py-7">
                          ...
                          <h5 class="card-title mb-0">Promoter</h5>
                        </div>
                      </div>
                    </a>
                  </div>
                    ...
                    <a href="help-center-article.html">
                      <div class="card help_card">
                        <div class="card-body py-7">
                          ...
                          <h5 class="card-title mb-0">VIP+</h5>
                        </div>
                      </div>
                    </a>
                  </div>
