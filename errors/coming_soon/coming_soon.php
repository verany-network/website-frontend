      ...
      <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                <p class="lead">Wir befinden uns aktuell im Aufbau, wir bitten um Verständnis!</p>
                <br>
                <!-- countdown -->
                ...
                <div class="row d-none d-md-flex">
                    <div class="col-lg-8 mx-auto">
                        ...
                        <hr class="w-10 border-top-2 my-6 my-xl-7 border-warning">
                        <p>Du willst am neusten Stand sein? Dann abonniere unseren Newsletter!</p>
                        <form class="input-transparent">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Email">
                                <div class="input-group-append">
                                  <a href="#" class="input-group-text btn btn-light btn-sub">Abonnieren</a>
                                </div>
                              </div>
                        </form>
                    </div>
