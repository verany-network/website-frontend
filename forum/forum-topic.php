    ...
    <main class="main-content gradient-lg position-relative">
      ...
      <div class="content-section news-section carousel-spotlight ig-carousel text-light">
        <div class="container">
          ...
          <div class="position-relative">
            <div class="row">
                  ...
                  <div class="row no-gutters">
                    <div class="col-md-2">
                      <div class="bg-dark_A-20 border-md-right border-secondary h-100 p-3">
                        ...
                        <div class="mb-2">
                          <img class="forum-topic-img img" src="http://localhost/assets/img/avatar/3.jpg" alt="User">
                        </div>
                        <div class="small">
                    ...
                    <div class="col-md-10">
                      <div class="d-flex flex-column h-100 p-4">
                        <div class="flex-1">
                          ...
                          <img src="http://localhost/assets/img/content/product/01.jpg" alt="Game" class="mb-4">
                          <p>
              ...
              <div class="col-12 mb-6">
                <div class="border border-secondary rounded">
                  <div class="d-flex align-items-center bg-secondary px-4 py-2">
                    <span class="fw-600 ls-1 text-uppercase small">1 day ago</span>
                    <span class="fw-600 ls-1 text-uppercase small ml-auto">#2</span>
                  </div>
                  <div class="row no-gutters">
                    <div class="col-md-2">
                      <div class="bg-dark_A-20 border-right border-secondary h-100 p-3">
                        ...
                        <div class="mb-2">
                          <img class="forum-topic-img img" src="http://localhost/assets/img/avatar/2.jpg" alt="User">
                        </div>
                        <div class="small">
                          <span class="d-block mb-1"><i class="fas fa-clock text-warning mr-1"></i><span class="fw-600">Join Date</span>: 7/23/2013</span>
                          <span class="d-block"><i class="fas fa-comment-alt text-warning mr-1"></i><span class="fw-600">Posts</span>: 6</span>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-10">
          ...
          <!-- comment (not auth) -->
          <div>
            <div class="border border-secondary px-5 py-4 text-center">
              <span>To post a comment, please <a href="#" class="font-italic text-primary">login</a> or <a href="#" class="font-italic text-primary">register</a> a new account.</span>
            </div>
          </div>
          <!-- /.comment (not auth) -->
          <br>
          ...
          <div>
            <div class="mb-4">
              <h4 class="mb-2">Reply to this Topic</h4>
              <span>When posting, please be sure that the content of your post does not violate our <a href="#" class="text-primary">Terms of Service</a>.</span>
            </div>
            <div class="border border-secondary px-5 py-4 text-center">
                ...
                <div class="row">
                  <div class="col-md-11 ml-auto">
                    <div class="d-flex align-items-center justify-content-end">
                      <div class="mr-auto">
                        <a href="#" class="btn btn-outline-warning px-4 d-flex align-items-center"><i class="far fa-image lead-2 mr-2"></i>Upload an Image</a>
                      </div>
                      ...
                      <div><button class="btn btn-warning" type="submit">Post Reply</button></div>
                    </div>
                  </div>
                </div>
              </form>
