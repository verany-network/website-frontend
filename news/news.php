                    ...
                    <div class="row news-list">
                      ...
                      <div class="news-item col-12 mb-4">
                        <div class="row">
                          ...
                          <div class="col-lg-8">
                            <div class="text-gray">
                              <h5 class="text-uppercase fw-600"><a href="news-article.php">Mauris ornare</a></h5>
                              <div class="small-3 mb-2">
                                <span class="mr-2"><i class="fas fa-calendar-alt mr-1"></i> 8:11pm</span>
                                <a href="news-article.php" class="comments"><i class="fas fa-comment-alt mr-1"></i> <span>7</span> comments</a>
                              </div>
                          ...
                          <div class="col-lg-8">
                            <div class="text-gray">
                              ...
                              <div class="small-3 mb-2">
                                ...
                                <a href="news-article.php" class="comments"><i class="fas fa-comment-alt mr-1"></i> <span>0</span> comments</a>
                              </div>
                              <p>Aliquam ipsum elit, lobortis et elit ultrices, suscipit hendrerit ligula. Morbi vulputate, urna in tincidunt lacinia, orci lectus convallis lectus, vel dictum felis urna eget nisi. Proin ac bibendum diam.</p>
                            </div>
                          </div>
