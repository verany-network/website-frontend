...
<head>
    ...
    <title>Verany • Register | Verify</title>
        ...
        <div class="row">
            <div class="col-4 col-sm-3 col-md-2 mr-auto">
                <a class="navbar-brand logo" href="#">
                    <img src="../assets/img/logo.png" alt="Verany" class="logo-light mx-auto">
                </a>
            </div>
                ...
                <ul class="nav navbar-nav d-none d-sm-inline-flex flex-row">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu position-absolute" aria-labelledby="dropdownUser">
                            <a class="dropdown-item" href="./profile.php"><span class="mr-2"><i class="fas fa-user"></i></span>My Profile</a>
    ...
    <div class="content-section text-light">
        <div class="container">
                        ...
                        <div class="timeline-horizontal">
                            ...
                            <div class="timeline-item flex-1 border-secondary p-0" data-step="&#xe61d;">
                                <div class="pt-8 pb-7 px-2 px-sm-4 border-bottom border-secondary">
                                    <span class="text-uppercase small-3 fw-600">Password</span>
                                </div>
                            </div>
                            <div class="timeline-item flex-1 border-secondary p-0" data-step="&#xe6fd;">
                                <div class="pt-8 pb-7 px-2 px-sm-4 border-bottom border-secondary border-right">
                                    <span class="text-uppercase small-3 fw-600">Success</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="position-relative">
                <div class="row">
                    <div class="col-lg-8 mb-8 mb-lg-8">
                        <div>
                            <div class="mb-7">
                                <h4>Verify</h4>
