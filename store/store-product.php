          ...
          <div class="row gutters-y">
                  ...
                  <div class="product-body">
                    ...
                    <div class="carousel-product">
                      <div class="slider text-secondary" data-slick="product-body">
                        <img src="http://localhost/assets/img/content/product/01.jpg" alt="Game">
                        <img src="http://localhost/assets/img/content/product/02.jpg" alt="Game">
                        <img src="http://localhost/assets/img/content/product/01.jpg" alt="Game">
                        <img src="http://localhost/assets/img/content/product/01.jpg" alt="Game">
                      </div>
                      <div class="slider product-slider-nav text-secondary">
                        <div class="slide-item px-1"><img src="http://localhost/assets/img/content/product/01.jpg" class="screenshot" alt="Game"></div>
                        <div class="slide-item px-1"><img src="http://localhost/assets/img/content/product/02.jpg" class="screenshot" alt="Game"></div>
                        <div class="slide-item px-1"><img src="http://localhost/assets/img/content/product/01.jpg" class="screenshot" alt="Game"></div>
                        <div class="slide-item px-1"><img src="http://localhost/assets/img/content/product/01.jpg" class="screenshot" alt="Game"></div>
                      </div>
                    </div>
                    ...
                    <div class="mb-6">
                      ...
                      <div>
                        <div class="owl-carousel carousel_sm" data-carousel-items="1, 2, 3, 3" data-carousel-margin="10" data-carousel-nav="false" data-carousel-dots="true">
                          <div class="item">
                            <a href="#">
                              <div class="d-flex h-100 bs-c br-n bp-c ar-8_5 position-relative" style="background-image: url(http://localhost/assets/img/content/cont/cg-c_02.jpg);">
            ...
            <div class="col-lg-4">
              <div class="bg-dark_A-20 p-4 mb-4">
                <img src="http://localhost/assets/img/content/cont/product_preview.jpg" alt="Product" class="mb-3">
      ...
      <section class="container text-light">
        <div class="border border-secondary py-5 px-2">
          ...
          <div class="owl-carousel" data-carousel-items="1, 3, 6">
            <!-- item -->
            <div class="item mx-3">
              <img src="http://localhost/assets/img/content/img_01.jpg" alt="Game" class="mb-3">
                ...
                <div class="row">
                  ...
                  <div class="col-12 mb-7">
                    <div class="d-flex flex-wrap flex-sm-nowrap">
                      <div><img src="http://localhost/assets/img/avatar/1.jpg" class="d-none d-sm-block avatar rounded" alt="Avatar"></div>
