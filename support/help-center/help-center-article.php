...
<html lang="de">
  <head>
    ...
    <title>Verany • Help Center | Article</title>

    <!-- CSS -->
    <link href="ashttp://localhost/assetssets/css/fonts/etline-font.min.css" rel="stylesheet">
                ...
                <div>
                  ...
                  <div class="alert bg-light_A-10 border-warning py-6" role="alert">
                    <div class="d-flex align-items-center">
                      <div class="lh-1">
                        <span class="ti-info text-warning lead-3"></span>
                      </div>
                      <div class="ml-3 lh-1">
